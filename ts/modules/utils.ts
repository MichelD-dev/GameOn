...
*/
  setErrorMessage(id, '')
  ;(document.getElementById(id) as HTMLInputElement).value = trimmedValue
    .toLowerCase()
    .replace(/  +/g, ' ')
  return true
}
...
const setErrorMessage = (id: string, message: string) => {
  ...
  if (fieldIsATextInput) {
    ...
    ;(document.getElementById(id) as HTMLInputElement).classList.add('error')
  }
  ...
  if (message === '' && fieldIsATextInput) {
    ;(document.getElementById(id) as HTMLInputElement).classList.remove('error')
    ;(document.getElementById(id) as HTMLInputElement).classList.add('success')
  }
}
